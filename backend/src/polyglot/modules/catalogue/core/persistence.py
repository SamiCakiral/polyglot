...
form_analyses = Table(
    ...
    CheckConstraint(
        "length(surface) BETWEEN 1 AND 500 "
        "AND length(normalization_key) BETWEEN 1 AND 500",
        ...
        rows = (
            await self._session.execute(
                text(
                    ...
                    "JOIN catalogue.language_packs AS pack ON pack.pack_id = publication.pack_id "
