...
export const getListLanguagePacksResponseMock = (
  ...
  items: Array.from(
    ...
    pack_revision_id: faker.string.uuid(),
    revision_no: faker.number.int(),
    segmentation_policy_revision_id: faker.string.uuid(),
    ...
    target_script_codes: Array.from(
      { length: faker.number.int({ min: 1, max: 10 }) },
      (_, i) => i + 1,
    ).map(() => faker.string.alpha({ length: { min: 10, max: 20 } })),
    target_variety_id: faker.string.uuid(),
    text_direction: faker.string.alpha({ length: { min: 10, max: 20 } }),
  })),
  next_cursor: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    null,
...
export const getListLanguageProfilesResponseMock = (
  ...
  items: Array.from(
    ...
    status: faker.string.alpha({ length: { min: 10, max: 20 } }),
    target_variety_id: faker.string.uuid(),
    training_access: faker.string.alpha({ length: { min: 10, max: 20 } }),
    updated_at: faker.date.past().toISOString().slice(0, 19) + "Z",
    version: faker.number.int(),
  })),
  ...overrideResponse,
...
export const getEvaluateExerciseAttemptMockHandler = (
  overrideResponse?:
    | AttemptResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
  ...
  return http.post(
    "*/api/v1/attempts/:attemptId\\:evaluate",
    async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {
      await delay(0);
      ...
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === "function"
            ? await overrideResponse(info)
            : overrideResponse
          : getEvaluateExerciseAttemptResponseMock(),
        { status: 200 },
      );
    },
    options,
...
export const getGetGrammarToolboxMockHandler = (
  overrideResponse?:
    | GrammarToolboxResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<GrammarToolboxResponse> | GrammarToolboxResponse),
  options?: RequestHandlerOptions,
) => {
  return http.get(
      ...
      return HttpResponse.json(
        overrideResponse !== undefined
          ? typeof overrideResponse === "function"
            ? await overrideResponse(info)
            : overrideResponse
          : getGetGrammarToolboxResponseMock(),
        { status: 200 },
      );
    },
    options,
...
export const getPolyglotV2APIMock = () => [
  ...
  getEvaluateExerciseAttemptMockHandler(),
